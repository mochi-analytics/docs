---
title: Discord.js command analytics in under five minutes
description: Add command usage, success rate, latency, server growth, and health analytics to a discord.js v14 bot with Mochi Analytics.
---

import { Callout } from 'nextra/components'

# Discord.js command analytics

Add privacy-friendly analytics to a discord.js bot without building event
storage, aggregation queries, or a dashboard. The setup below starts tracking
slash commands, context-menu commands, server growth, and health snapshots in
under five minutes.
